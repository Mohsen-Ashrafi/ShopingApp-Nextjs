      ...
      <table className="min-w-full border rounded-xl">
        <thead className="bg-gray-100 text-gray-700 font-semibold text-[11px] md:text-xs">
          <tr>
            {adminPaymentListTableTHeads.map((item) => (
              <th
                key={item.id}
                className="whitespace-nowrap px-2 py-2 md:px-4 md:py-3 border-b border-gray-200 text-center"
              >
                {item.label}
              </th>
            ))}
        ...
        <tbody className="text-[10px] md:text-xs">
          {payments.map((payment, index) => (
            ...
            >
              <td className="text-center border-b px-2 py-1 md:px-4 md:py-2">
                {index + 1}
              </td>
              <td className="text-center border-b px-2 py-1 md:px-4">
                {payment.invoiceNumber}
              </td>
              <td className="text-center border-b px-2 py-1 md:px-4 max-w-[120px] md:max-w-[200px] truncate">
                {payment.description}
              </td>
              <td className="text-center border-b px-2 py-1 md:px-4">
              ...
              <td className="text-center border-b px-2 py-1 md:px-4 font-semibold text-[11px] md:text-sm">
                ${payment.amount}
              </td>
              <td className="text-center border-b px-2 py-1 md:px-4">
